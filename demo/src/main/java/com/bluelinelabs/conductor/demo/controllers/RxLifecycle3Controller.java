...
import com.bluelinelabs.conductor.rxlifecycle3.ControllerEvent;
import com.bluelinelabs.conductor.rxlifecycle3.RxController;
...
public class RxLifecycle3Controller extends RxController {
    ...
    protected void onAttach(@NonNull View view) {
        ...
        (((ActionBarProvider)getActivity()).getSupportActionBar()).setTitle("RxLifecycle3 Demo");
