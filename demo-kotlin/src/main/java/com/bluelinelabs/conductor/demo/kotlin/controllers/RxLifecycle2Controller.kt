...
class RxLifecycle2Controller : RxController() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup): View {
        ...
        view.setBackgroundColor(ContextCompat.getColor(container.context, R.color.blue_grey_300))
    ...
    override fun onAttach(view: View) {
        ...
        (activity as ActionBarProvider).supportActionBar?.title = "RxLifecycle2 Demo"
